...
| Zero-copy record path | `scripts/audit-zero-copy.ts` + xctrace recipe | Local, on demand |
| Localization (ko/ja/zh-Hans) | `scripts/lint-localization.ts` + `scripts/l10n-screenshots.sh` | ✅ CI / artifacts |
