...
| Zero-copy record path | `mise run audit:zero-copy` + xctrace recipe | Local, on demand |
| Localization (ko/ja/zh-Hans) | `mise run lint:localization` + `scripts/l10n-screenshots.sh` | ✅ CI / artifacts |
