...
| Unit + integration suites | `swift test` (42 tests: capture, encoder, splice clock, mixer, rate control, settings, trim, effects) | ✅ CI |
...
| --- | --- | --- | --- |
| 1 | macOS 13.3, Apple Silicon, 1 display | Full record flow ×4 modes, trim, export | ☐ |
