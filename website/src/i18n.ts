...
export const translations: Record<Language, Copy> = {
  ko: {
    ...
    features: {
      title: '60 fps를 넘어',
      accent: '화면과 같은 속도로',
      frameRateTitle: '프레임 레이트. 매끄러움의 차이.',
      frameRateDescription: '디스플레이 주사율에 맞춰 모든 움직임을 더욱 자연스럽게 담아냅니다.',
      matchedRate: 'fps · 144 Hz에 맞춤',
      codecTitle: 'H.265. 선명함은 높이고, 용량은 줄이고.',
      codecDescription: '고효율 압축으로 화질은 그대로, 파일은 더 가볍게.',
      resolutionTitle: '최대 5K. 디테일의 차이.',
      resolutionDescription: 'Retina의 선명함을 픽셀 하나까지 또렷하게 담아냅니다.',
    },
    free: {
      title: '무료',
      accent: '조건 없이',
  ...
  en: {
    ...
    features: {
      ...
      frameRateTitle: 'Frame rate. Smooth by design.',
      frameRateDescription: 'Matched to your display, so every movement looks natural.',
      matchedRate: 'fps · Matched to 144 Hz',
      codecTitle: 'H.265. More detail. Less data.',
      codecDescription: 'Efficient compression keeps quality high and files light.',
      resolutionTitle: 'Up to 5K. Detail makes the difference.',
      resolutionDescription: 'Capture Retina clarity, down to the last pixel.',
    },
    free: {
      title: 'Free',
  ...
  ja: {
    ...
    features: {
      title: '60 fpsを超えて',
      accent: '画面と同じ速さで',
      frameRateTitle: 'フレームレート。なめらかさが違う。',
      frameRateDescription: 'ディスプレイのリフレッシュレートに合わせ、すべての動きを自然に記録します。',
      matchedRate: 'fps · 144 Hzに合わせて',
      codecTitle: 'H.265。鮮明さは高く、容量は軽く。',
      codecDescription: '高効率な圧縮で、画質を保ちながらファイルを軽量に。',
      resolutionTitle: '最大5K。違いはディテールに。',
      resolutionDescription: 'Retinaの鮮明さを、1ピクセルまでくっきり記録します。',
    },
    free: {
      title: '無料',
      accent: '条件なし',
  ...
  'zh-Hans': {
    ...
    features: {
      title: '超越 60 fps',
      accent: '与屏幕同速',
      frameRateTitle: '帧率。流畅大不同。',
      frameRateDescription: '匹配显示器刷新率，让每个画面都自然流畅。',
      matchedRate: 'fps · 匹配 144 Hz',
      codecTitle: 'H.265。画质更高，文件更小。',
      codecDescription: '高效压缩兼顾清晰画质与轻巧文件。',
      resolutionTitle: '最高 5K。细节见真章。',
      resolutionDescription: '细腻呈现 Retina 的每一个像素。',
    },
    free: {
      title: '免费',
      accent: '没有附加条件',
